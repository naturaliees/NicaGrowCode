...
from .serializers import (
    ...
    VentasSerializer, CredencialesClienteSerializer, CredencialesVendedorSerializer,
    MetodoPagoSerializer, MetodosEnvioSerializer, PedidosSerializer,
    DetallePedidoSerializer, HistorialBusquedaSerializer, ReseñasSerializer
)
